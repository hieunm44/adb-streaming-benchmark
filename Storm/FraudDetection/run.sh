...
do
    ...
    command="java -cp target/FraudDetection-1.0.jar FraudDetection.FraudDetection --rate 0 --sampling 100 --parallelism $config"
    # command="ls"
    ...
    echo "CPU: $avg_cpu%"
    echo "MEM: $avg_mem%"
    echo "Storm_FD_$config, $throughput, $latency, $avg_cpu%, $avg_mem%" >> "../../results.csv" 
