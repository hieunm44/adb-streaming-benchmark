...
do
    ...
    command="java -cp target/VoipStream-1.0.jar VoipStream.VoipStream Configurations/$config.json"
    # command="ls"
    ...
    echo "CPU: $avg_cpu%"
    echo "MEM: $avg_mem%"
    echo "Storm_VS_$config, $throughput, $latency, $avg_cpu%, $avg_mem%" >> "../../results.csv" 
