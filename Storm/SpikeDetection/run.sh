...
do
    ...
    command="java -cp target/SpikeDetection-1.0.jar SpikeDetection.SpikeDetection --rate 0 --sampling 100 --parallelism $config"
    # command="ls"
    ...
    echo "CPU: $avg_cpu%"
    echo "MEM: $avg_mem%"
    echo "Storm_SD_$config, $throughput, $latency, $avg_cpu%, $avg_mem%" >> "../../results.csv" 
