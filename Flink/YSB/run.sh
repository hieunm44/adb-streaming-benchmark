...
do
    ...
    command="java -cp target/YSB-1.0.jar YSB.YSB --rate 0 --sampling 0 --parallelism $config --chaining"
    # command="ls"
    ...
    echo "CPU: $avg_cpu%"
    echo "MEM: $avg_mem%"
    echo "Flink_YSB_$config, $throughput, $latency, $avg_cpu%, $avg_mem%" >> "../../results.csv" 
